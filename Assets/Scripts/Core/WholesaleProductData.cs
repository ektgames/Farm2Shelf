...
namespace Farm2Shelf.Core
{
    ...
    public static class WholesaleDatabase
    {
        private static readonly List<WholesaleProductDef> products = new List<WholesaleProductDef>()
        {
            ...
            new WholesaleProductDef("p12", "Çıtır Sokak Simiti", "Crispy Turkish Bagel (Simit)", "🥖", FurnitureType.BakeryCounter, 2, 10, 50),
            new WholesaleProductDef("p13", "Peynirli Poğaça", "Cheese Pastry (Poğaça)", "🥨", FurnitureType.BakeryCounter, 2, 12, 50),
